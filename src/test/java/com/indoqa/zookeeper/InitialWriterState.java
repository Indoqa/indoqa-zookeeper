...
public final class InitialWriterState extends AbstractZooKeeperState {

    public static final InitialWriterState INITIAL_WRITER_STATE = new InitialWriterState();

    private InitialWriterState() {
        super("Initializing Writer");
    }
