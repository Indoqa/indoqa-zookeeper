...
public final class InitialReaderState extends AbstractZooKeeperState {

    public static final InitialReaderState INITIAL_READER_STATE = new InitialReaderState();

    private InitialReaderState() {
        super("Initializing Reader");
    }
